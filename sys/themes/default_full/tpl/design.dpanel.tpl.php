...
?>
    ...
    <div class="box_dpanel">
        <?if($user->access('news_dopusk')) {?><a class="block_dpanel" href="./news/"><i class="fa fa-rss icon_bar" aria-hidden="true"></i>
            <br/> Новости</a><?}?>
        <?if($user->access('news_dopusk')) {?><a class="block_dpanel" href="./blogs/"><i class="fa fa-rss icon_bar" aria-hidden="true"></i>
            <br/> Блоги</a><?}?>
        ...
        <div class="box_content">
            ...
            if ($arr = $q->fetchAll()) {
                foreach ($arr AS $ank) {
                    ...
                    $post->url = '/engDev/profile.view.php?id=' . $p_user->id;
    ...
    <div class="boxs_dpanel boxs_inline box_height">
        <div class="box_title"><i class="fa fa-list-alt" aria-hidden="true"></i> Последние действия (20) <span class="box_act"><a href="./engDev/log.actions.php"><i class="fa fa-share-alt-square" aria-hidden="true"></i></a></span></div>
        <div class="box_content">
            <? $listing = new listing();
    ...
    <div class="boxs_dpanel boxs">
        <div class="box_title"><i class="fa fa-area-chart" aria-hidden="true"></i> Статистика посещения <span class="box_act"><a href="./engDev/statistics.php"><i class="fa fa-share-alt-square" aria-hidden="true"></i></a></span></div>
        <?
